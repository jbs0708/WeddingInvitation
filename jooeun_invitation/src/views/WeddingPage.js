...
const WeddingPage = () => {
  return (
    <div className="body">
      ...
      <div className="date">
        <h1>2024. 12. 28<br />토요일 오전11시 울림교회</h1>
      </div>

      <img className="our-story1-img" src="../../assets/picture/weddingPic_2.jpg" alt="story1" />
      ...
      <img className="our-story2-img" src="../../assets/picture/weddingPic_3.jpg" alt="story2" />
      ...
      <img className="our-story3-img" src="../../assets/picture/weddingPic_4.jpg" alt="story3" />
      ...
      <img className="our-story4-img" src="../../assets/picture/weddingPic_5.jpg" alt="story4" />
      ...
      <img className="our-story4-img" src="../../assets/picture/weddingPic_6.jpg" alt="story5" />
